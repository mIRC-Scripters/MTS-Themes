alias Eistee.nick {
  if ($prop == error) {
    ...
    elseif ((%::cmode == @) || ($1 isop $2))  return $+(,$iif($cnick($1).color != $color(Listbox text),$cnick($1).color,05),$chr(40),12@,$color(Kick text).dd,$1,,$iif($cnick($1).color != $color(Listbox text),$cnick($1).color,05),$chr(41),,$color(Kick text).dd)
    ...
    elseif ((%::cmode == +) || ($1 isvo $2))  return $+(,$iif($cnick($1).color != $color(Listbox text),$cnick($1).color,05),$chr(40),09+,$color(Kick text).dd,$1,,$iif($cnick($1).color != $color(Listbox text),$cnick($1).color,05),$chr(41),,$color(Kick text).dd)
    ...
    elseif (((%::cmode == @) || ($1 isop $2)) && ($1 != %::knick))  return $+(,$cnick($1).color,$chr(40),12@,$1,,$cnick($1).color,$chr(41),)
    elseif (((%::cmode == %) || ($1 ishop $2)) && ($1 != %::knick)) return $+(,$cnick($1).color,$chr(40),10%,$1,,$cnick($1).color,$chr(41),)
    elseif (((%::cmode == +) || ($1 isvo $2)) && ($1 != %::knick))  return $+(,$cnick($1).color,$chr(40),09+,$1,,$cnick($1).color,$chr(41),)
...
alias Eistee.address {
  if (!$1) return
    ...
    if ($prop == error) return $+(05,$chr(40),,$color(Kick text).dd,$replace($1,!,$+(15!,$color(Kick text).dd),@,$+(15@,$color(Kick text).dd)),05,$chr(41),,$color(Kick text).dd)
    else return $+(,$color(Normal text).dd,$chr(40),,$replace($1,!,15!,@,15@),,$color(Normal text).dd,$chr(41),))
  }
}
alias Eistee.chan {
  if (!$1) return
...
alias Eistee.pre {
  if ($1 == 01) return $+($2,14•15•00•)
  if ($1 == 02) return $+($2,12•11•00•)
  if ($1 == 03) return $+($2,03•09•00•)
  if ($1 == 04) return $+($2,05•04•00•)
  if ($1 == 06) return $+($2,06•13•00•)
  if ($1 == 07) return $+($2,05•07•00•)
  if ($1 == 10) return $+($2,03•10•00•)
  if ($1 == 11) return $+($2,10•11•00•)
  if ($1 == 12) return $+($2,12•11•00•)
}

alias Eistee.whois {
  if (%::nick)     { %:echo $timestamp $Eistee.pre(02, ) 12··············11··············00··············15··············14·············· }
  ...
  if (%::chan)     { %:echo $timestamp $Eistee.pre(02, )  $+ $color(Background).dd $+ %::nick  $+ $color(Info text).dd $+ chan $replace(%::chan,$chr(94),$+(07,$chr(94),),$chr(42),$+(13,$chr(42),),$chr(64),$+(12,$chr(64),),%,10%,+,09+) }
...
alias Eistee.who {
  %:echo $timestamp $Eistee.pre(02, ) 12··············11··············00··············15··············14··············
