...
LOAD !script %:echo $_padcalc1(*) $_padcalc2(<load>) %::pre  $+ chelho 1.2 by CH $+ 
UNLOAD !script %:echo $_padcalc1(*) $_padcalc2(<unload>) %::pre  $+ chelho 1.2 by CH $+ 
...
raw.333 !script %:echo $_padcalc1(*) $_padcalc2(<topic>) %::pre set by %::nick on %::text
