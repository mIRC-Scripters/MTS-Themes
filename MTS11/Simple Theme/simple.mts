...
LOAD <PRE> 02Loaded Simple theme by oMri^^ [v1.4]
SCRIPT simple.mrc
...
RAW.314 <pre> 10Whowas: 02<nick>(<address>) 10(02<text>10)
RAW.381 <pre> 10You are now a 02IRC Operator
RAW.401 <pre> 04No such nickname <nick>
RAW.403 <pre> 04No such channel <chan>
...
RAW.251 <pre> 10Users: 02<users> 10Invisible: 02<value>
