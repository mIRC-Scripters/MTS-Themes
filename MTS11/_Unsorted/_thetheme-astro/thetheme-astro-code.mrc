alias tt-script.name { return The Theme - Astro 72 }
...
alias thetheme.textquery {
  %:echo 03 $+  $+ 09 $+ %::cmode $+ 01 $+ %::nick $+ :01 %::text
}
alias thetheme.textqueryself {
  %:echo 03 $+ %::cmode $+ 01 $+ %::me $+  -> 01 %::text 
}

alias thetheme.textchanself {
  %:echo 03  09 %::cmode 01 %::me >01 %::text
}
